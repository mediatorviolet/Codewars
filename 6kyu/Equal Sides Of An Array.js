 ...
 * Your function will return the index 3, because at the 3rd position of the array, the sum of left side of the index ({1
 * 2,3}) and the sum of the right side of the index ({3,2,1}) both equal 6.
 *
...
const findEvenIndex = (arr) => {
    ...
    if (arr.slice(0, arr.length - 1).reduce((a, b) => a + b) === 0)
        return arr.length - 1;
...
findEvenIndex([20, 10, 30, 10, 10, 15, 35]); // Output 3
findEvenIndex([20, 10, -80, 10, 10, 15, 35]); // Output 0
